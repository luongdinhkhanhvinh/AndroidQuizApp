package com.ldkvinh.quizandroid.Database;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.ldkvinh.quizandroid/databases/";
    private static String DB_NAME = "dbTrieuPhu.sqlite";
